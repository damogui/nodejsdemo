    ...
    <div class="contetn-show">
        ...
        <div>
            <div class="response-div mt20">
                <span>合作等级 :</span><span>{{CoTypeStr}}</span>
            </div>
        ...
        <div>
            <div class="response-div">
                <span>年生源量 :</span><span>{{StudentsStr}}</span>
            </div>
            <div class="response-div mt20">
                <span>校区数量 :</span><span>{{SchoolsStr}}</span>
            </div>
        </div>
        <div>
            <div class="response-div">
                <span>年营收 :</span><span>{{SalesStr}}</span>
            </div>
            <div class="response-div mt20">
                <span>老师数量 :</span><span>{{TeachersStr}}</span>
            </div>
        </div>
        <div>
            <div class="response-div">
