...
var module = {
    ...
    initBtns: function () {
        ...
        $("body").delegate("#stuEdit", "click", function () {
            window.location.href = "/Org/StudentManage/EditStu/" + stuId + "-" + stuEditionId+"/"+window.tokenID;
            //"?stuId=" + stuId;//跳转
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.Data) {
                ...
                stuEditionId = data.Data.EditionId;//教材id
                stuEditionName = data.Data.EditionName;//教材名
                stuStage = data.Data.StageId;//学段
...
function loadEdution(obj) {
    ...
    $.ajax({
        ...
        dataType: "json",
        data: {
            data: obj, EditionId: stuEditionId
        },
        success: function (data) {
            if (data.Data) {
                ...
                if (data.TagValue == "1") {
                    lui.initDropDownList({ warpid: "drop_Edition", width: 200, nameField: 'name', idField: 'id', data: arrEdutions, subtextlength: 10, defaultValue: stuEditionId, defaultText: stuEditionName });//教材版本
