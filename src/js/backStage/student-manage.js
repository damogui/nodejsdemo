...
//新添加（不影响之前业务逻辑）
var stuOldStage;//学段
var stuOldEditionId;//教材id
var stuOldEditionName;//教材名
...
var gradeArr = [{ name: '一年级', id: '1', pid: '' }, { name: '二年级', id: '2', pid: '00' }, { name: '三年级', id: '3', pid: '00' }, { name: '四年级', id: '4', pid: '00_01' }, { name: '五年级', id: '5', pid: '00_01' }, { name: '六年级', id: '6', pid: '00_02' }];//年级初始化
...
var module = {
    ...
    initBtns: function () {
        ...
        $("body").delegate(".seeDetail", "click", function () {
            ...
            window.location.href = "/Org/StudentManage/StuDetail/" + dataId+"/"+window.tokenID;
        ...
        $("body").delegate(".continue", "click", function () {
            ...
            stuOldStage = $(this).attr("data-stage");//学段
            stuOldEditionId = $(this).attr("data-EditionId");//教材id
            stuOldEditionName = $(this).attr("data-EditionName");//教材名
        ...
        $("body").delegate('.teacher-grade', "click", function () {
            ...
            var satgeStr = $("#drop_stage").attr("data-id");
          
           
            GetEdutionData(satgeStr);

          
            $("#lszT").css("display", "");
            $("#wsT").css("display", "none");
            $("#add-grade").show();
            if ($("#drop_edutype").attr("data-id") == "0") {
                $("#lstab").click();//63
        ...
        $("body").delegate("#btnAddStu", "click", function () {
            ...
            jsonAdd.EduType = $("#drop_edutype").attr("data-id");//63，54
            //if ($("#rad_54").hasClass("active")) {
            //    jsonAdd.EduType = 1;//1为54，0为63
            //}
            jsonAdd.StageId = $("#drop_stage").attr("data-id");//学段x、c、g
                    ...
                    if (data.Data == "0") {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                stuOldStage = $("#drop_stage").attr("data-id");//学段
                                stuOldEditionId = $("#editionName").attr("data-id");//教材id
                                stuOldEditionName = $("span[data-type=11]").html();//教材名
...
function loadEdution(obj) {
    ...
    $.ajax({
        ...
        dataType: "json",
        data: {
            data: obj, EditionId: stuOldEditionId
        },
        success: function (data) {
            if (data.Data) {
                ...
                if (data.TagValue == "1") {
                    lui.initDropDownList({ warpid: "drop_Edition", width: 185, nameField: 'name', idField: 'id', data: arrEdutions, subtextlength: 10, defaultValue: stuOldEditionId, defaultText: stuOldEditionName });//教材版本
...
////年级的下拉
lui.initDropDownList({ warpid: "drop_nj", width: 80, nameField: 'name', idField: 'id', data: gradeArr });

//x、c、g
lui.initDropDownList({ warpid: "drop_stage", width: 80, nameField: 'name', idField: 'id', data: [{ name: '小学', id: 'X', pid: 'X' }, { name: '初中', id: 'C', pid: 'C' }, { name: '高中', id: 'G', pid: 'G' }], selectedCallBack: StageChange });
//五四、六三
lui.initDropDownList({ warpid: "drop_edutype", width: 80, nameField: 'name', idField: 'id', data: [{ name: '六三制', id: '0', pid: '0' }, { name: '五四制', id: '1', pid: '1' }], selectedCallBack: EdutypeChange });
...
//学段变化
function StageChange(warpid, selectedValue, selectedText) {
    
    var eduType = $("#drop_edutype").attr("data-id");
    //清空教材版本
    $("#editionName").attr("data-id", "0");
    $("#editionName").html("");
    switch (selectedValue) {
        case "X":
            $("#drop_edutype").show();
            if (eduType == "0") {//63
                lui.initDropDownList({ warpid: "drop_nj", width: 80, nameField: 'name', idField: 'id', data: [{ name: '一年级', id: '1', pid: '' }, { name: '二年级', id: '2', pid: '00' }, { name: '三年级', id: '3', pid: '00' }, { name: '四年级', id: '4', pid: '00_01' }, { name: '五年级', id: '5', pid: '00_01' }, { name: '六年级', id: '6', pid: '00_02' }] });
                
            } else {
                lui.initDropDownList({ warpid: "drop_nj", width: 80, nameField: 'name', idField: 'id', data: [{ name: '一年级', id: '1', pid: '' }, { name: '二年级', id: '2', pid: '00' }, { name: '三年级', id: '3', pid: '00' }, { name: '四年级', id: '4', pid: '00_01' }, { name: '五年级', id: '5', pid: '00_01' }] });
        ...
        case "C":
            $("#drop_edutype").show();
            if (eduType == "0") {//63
                lui.initDropDownList({ warpid: "drop_nj", width: 80, nameField: 'name', idField: 'id', data: [{ name: '七年级', id: '7', pid: '7' }, { name: '八年级', id: '8', pid: '8' }, { name: '九年级', id: '9', pid: '9' }] });

            } else {
                lui.initDropDownList({ warpid: "drop_nj", width: 80, nameField: 'name', idField: 'id', data: [{ name: '六年级', id: '6', pid: '6' }, { name: '七年级', id: '7', pid: '7' }, { name: '八年级', id: '8', pid: '8' }, { name: '九年级', id: '9', pid: '9' }] });
        ...
        case "G":
            //隐藏学制
            $("#drop_edutype").hide();
            lui.initDropDownList({ warpid: "drop_nj", width: 80, nameField: 'name', idField: 'id', data: [{ name: '高一', id: '10', pid: '10' }, { name: '高二', id: '11', pid: '11' }, { name: '高三', id: '12', pid: '12' }] });
...
//学段变化
function EdutypeChange(warpid, selectedValue, selectedText) {
    
    var eduType = selectedValue;
    var stage = $("#drop_stage").attr("data-id");
    switch (stage) {
        case "X":
            $("#drop_edutype").show();
            if (eduType == "0") {//63
