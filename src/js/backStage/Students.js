    ...
    function SetEChart(index) {
        ...
        switch (index) {
            case 1:
                ...
                data2 = [{ value: resultData.GradeMessage.StuXCount, name: '小学生' }, { value: resultData.GradeMessage.StuCCount, name: '初中生' }, { value: resultData.GradeMessage.StuGCount, name: '高中生' }];
