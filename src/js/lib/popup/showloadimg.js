...
///针对div的loding
function ShowLoadingForDiv(obj) {
    if (obj == undefined) {
        return;
    }
    obj.html('<div class="data_img" style="text-align: center"><div class="big_area" style="margin-top:10px;line-height:30px;">' + jQuery("#divLoading").html() + '</div></div>');
}
...
exports.ShowLoadingForDiv = ShowLoadingForDiv;
